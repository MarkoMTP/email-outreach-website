  ...
  const replies = [
    {
      ...
      preview:
        "This sounds interesting! I'd love to schedule a call to discuss further...",
      time: "2m ago",
    },
    {
      status: "positive",
      ...
      preview:
        "Can you send me more details? We are definitely looking for something like this...",
      time: "15m ago",
    },
    {
      status: "neutral",
      ...
      preview:
        "Not sure if this fits our current needs, but I'm curious to learn more...",
      time: "1h ago",
    },
  ];
  ...
  return (
    <section className="smart-inbox">
      <div className="smart-inbox-container">
        ...
        <p className="section-subtitle">Your Inbox, Smarter Than Ever.</p>
        <p className="section-description">
          Every reply is analyzed and sorted automatically: positive leads at
          the top, neutral ones queued for follow-up, uninterested contacts
          archived. You can view and reply directly inside the dashboard — just
